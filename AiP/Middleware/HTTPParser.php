...
class HTTPParser
{
  ...
  public function __invoke($context)
  {
    ...
    // _POST/_PUT/_DELETE and _FILES
    $stream_name = null;
	
    if (in_array($method = $context['env']['REQUEST_METHOD'], array('POST', 'PUT', 'DELETE'))) {
        $context[$method = "_$method"]  = array();
        ...
        if (isset($context['env']['CONTENT_TYPE']) and strpos($context['env']['CONTENT_TYPE'], 'multipart/form-data') === 0) {
            self::parseMultipart($context['env']['CONTENT_TYPE'], $buffer, $context[$method], $context['_FILES']);
        } else {
            parse_str($buffer, $context[$method]);
        }
